module github.com/yourname/collector

go 1.22

require (
	github.com/lightningnetwork/lnd v0.17.5-beta // routerrpc protos
	google.golang.org/grpc v1.63.0
	modernc.org/sqlite v1.22.0 // tiny pure‑Go SQLite
)

// use Lightning Labs’ protobuf fork that supports hex‑encoded bytes
